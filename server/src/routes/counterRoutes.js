...
function CounterRoutes(authenticator) {
  ...
  this.initRoutes = function () {
    ...
    //Route for retrieving the list of all counters and related services
    this.router.get("/all", this.authenticator.isAdmin, (req, res, next) => {
      this.counterController
    ...
    this.router.get(
      ...
      (req, res, next) => {
        this.counterController
          .getConfiguredServices(req.params.counter_id)
    ...
    this.router.post(
      ...
      (req, res, next) => {
        this.counterController
          .addServicesToCounter(req.body.counter_id, req.body.services)
